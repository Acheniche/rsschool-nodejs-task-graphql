...
import { PostType, UserType, ProfileType } from './types/query.js';
import { createPost, createUser, changeProfile, changePost, changeUser, createProfile } from './types/mutation.js';
...
export const Mutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    deleteProfile: {
      ...
      resolve: 
      async (parent, args, { prisma }: FastifyInstance) => {
